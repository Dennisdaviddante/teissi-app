        ...
        <FormCardd v-if="currentStep === 2" title="Sección 2: Evaluación de Síntomas"
          ...
          <div class="space-y-4">
            <div class="bg-gray-50 p-4 rounded-lg">
              <p class="text-sm font-medium text-gray-700 mb-2">
                Pensamientos sobre el deseo de morir o dejar de vivir
              </p>
          ...
          <div class="space-y-4">
            <div class="bg-yellow-50 p-4 rounded-lg">
              <p class="text-sm font-medium text-gray-700 mb-2">
                Pensamientos generales de querer terminar con su vida sin métodos específicos
              </p>
              <div class="text-xs text-gray-600 space-y-1">
          ...
          <div class="space-y-4" v-if="showAdditionalIdeation">
            <div class="bg-orange-50 p-4 rounded-lg">
              <p class="text-sm font-medium text-gray-700 mb-2">
                Pensamientos suicidas con al menos un método considerado, pero sin plan detallado
              </p>
              <div class="text-xs text-gray-600 space-y-1">
          ...
          <div class="space-y-4" v-if="showAdditionalIdeation">
            <div class="bg-orange-50 p-4 rounded-lg">
              <p class="text-sm font-medium text-gray-700 mb-2">
                Pensamientos suicidas con cierta intención de llevarlos a cabo
              </p>
              <div class="text-xs text-gray-600 space-y-1">
          ...
          <div class="space-y-4" v-if="showAdditionalIdeation">
            <div class="bg-red-50 p-4 rounded-lg">
              <p class="text-sm font-medium text-gray-700 mb-2">
                Pensamientos suicidas con detalles elaborados y intención de llevarlos a cabo
              </p>
              <div class="text-xs text-gray-600 space-y-1">
            ...
            <div class="space-y-2">
              ...
              <div class="form-group">
                <div class="radio-group">
                  ...
                  <label>
                    <input type="radio" v-model.number="assessment.ideationIntensity.frequency" :value="2">
                    Unas pocas veces
                  </label>
                  <label>
                    <input type="radio" v-model.number="assessment.ideationIntensity.frequency" :value="3">
                    Muchas
                  </label>
                  <label>
                    <input type="radio" v-model.number="assessment.ideationIntensity.frequency" :value="4">
                    Todo el tiempo
                  </label>
                  <label>
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="flex items-center space-x-2 mt-2">
                ...
                <span class="text-sm font-medium" :class="getRiskTextColor(ideationRiskLevel)">
                  Riesgo: {{ ideationRiskLevel }}
                </span>
              </div>
            ...
            <div>
              ...
              <ul class="mt-4 list-disc list-inside text-sm text-gray-600">
                ...
                <li v-if="assessment.abortedAttempt.present">Intento Abortado: Sí. Observación: {{
                  assessment.abortedAttempt.description }}. Intentos: {{ assessment.abortedAttempt.totalAttempts }}</li>
                <li v-if="assessment.preparatoryActs.present">Actos Preparatorios: Sí. Observación: {{
...
export default {
  ...
  methods: {
    ...
    async submitFinalRemarks() {
      ...
      try {
        ...
        const response = await axios.put(
          `https://tesis-dn07.onrender.com/api/suicide-assessments/${this.savedAssessmentId}/final-remarks`,
    ...
    async fetchStudentDetails() {
      try {
        ...
        this.assessment.studentId = this.student._id;
        console.log('este es el estudiante cargadooooooo ', this.student.assignedPsychologist);
        this.loading = false;
      } catch (error) {
  ...
  computed: {
    ...
    ideationRiskLevel() {
      ...
      const trueRisk = (this.ideationType + this.assessment.ideationIntensity.frequency) / 2;
      if (trueRisk <= 1.5) return 'BAJO';
      if (trueRisk <= 2.5) return 'MEDIO';
      if (trueRisk <= 3.5) return 'ALTO';
      if (trueRisk <= 4) return 'MUY ALTO';
      if (trueRisk >= 4) return 'MUY ALTO/EXTREMO';
      return 'BAJO';
    }, ideationType() {
